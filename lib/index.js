	...
	async start() {
		...
		try {
			...
			await node.handle(HALL_SYNC_PROTOCOL, async (stream, connection) => {
				...
				if (typeof request !== "object" || request === null || !("version" in request) || request.version !== 1 || !("topic" in request) || request.topic !== "/dsh-human-buffer/room/hall/0.5.0" || !("request" in request)) {
